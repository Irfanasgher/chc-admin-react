            ...
            <Row>
                <Colxx xxs="12">
                    <div className="text-zero top-right-button-container">
                        <Link to='/app/users/create'><Button size='lg' color={'primary'}> <IntlMessages id="create" /></Button></Link>
                    </div>
                                        ...
                                        <Cell>
                                            {(rowData, rowIndex) => {
                                                return <div>
                                                    ...
                                                    {" "}{" "}
                                                    <Button color="danger" size="xs" className="mb-2" onClick={()=> deleteUser(rowData)}>
