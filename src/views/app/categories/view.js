            ...
            <Row>
                <Colxx xxs="12">
                    <div className="text-zero top-right-button-container">
                        <Link to='/app/categories/create'><Button size='lg' color={'primary'}> <IntlMessages id="create" /></Button></Link>
                    </div>
                    <Breadcrumb heading="menu.categories" match={props.match} />
                                            ...
                                            {(rowData, rowIndex) => {
                                                return <div>
                                                    <Button color="secondary" size="xs" className="mb-2">
                                                        <Link to={`/app/categories/edit/${rowData.slug}`} style={{color: 'white'}}><IntlMessages id="edit" /></Link>
                                                    </Button>
                                                    {" "}{" "}
