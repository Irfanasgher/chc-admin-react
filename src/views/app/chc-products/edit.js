...
export default function EditCHCProduct(props) {
                    ...
                    <Col xxs="10">
                        <div className='col-sm-12 col-lg-10 col-xs-12 '>
                            <Card>
                                <CardBody>
                                    <CardTitle>
                                        <IntlMessages id="updateCHCProduct"/>
                                    </CardTitle>
                                    <Form className="dashboard-quick-post" onSubmit={updateCHCProduct}>
                                        <FormGroup row>
                                            <Label sm="3">
