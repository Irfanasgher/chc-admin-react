        ...
        <Fragment>
            <Row>
                <Colxx xxs="12">
                    ...
                    <Breadcrumb heading="menu.roles" match={props.match} />
                                            ...
                                            {(rowData, rowIndex) => {
                                                return <div>
                                                    <Button color="secondary" size="xs" className="mb-2">
                                                        <Link to={`/app/roles/edit/${rowData.slug}`} style={{color: 'white'}}><IntlMessages id="edit" /></Link>
                                                    </Button>
                                                    {" "}{" "}
                                                    <Button color="danger" size="xs" className="mb-2" onClick={()=> deleteRole(rowData)}>
